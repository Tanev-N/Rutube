...
| Подписки                  | 389                | 1945               | 70.55 / ToR (70.55 подписки в месяц)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| История просмотра | 1529               | 7 649              | При каждом просмотре видое + примем коэффициент того, что раз в 25 видео пользователь будет заходить в свою историю<br />просмотра, получим 26 * RPS Для Просмотра / 25                                                                                                                                                                                                                                                                          |
...
Пользователь → Local DNS → Amazon Route 53
            			                    ↓          ↓         ↓
            				    Минск    Астана    Владивосток / Москва (Под одним IP /24)
...
| Параметр                                            | Общая нагрузка | Москва (60%) | Минск (15%) | Астана (15%) | Владивосток (10%) |
| ----------------------------------------------------------- | --------------------------- | ------------------ | ---------------- | ------------------ | ---------------------------- |
| **Сетевой трафик (Тбит/сутки)** |                             |                    |                  |                    |                              |
| Просмотр видео                                 | 78,552                      | 47,131             | 11,783           | 11,783             | 7,855                        |
| Загрузка видео                                 | 7,910                       | 4,746              | 1,187            | 1,187              | 791                          |
| **RPS (запросы в секунду)**            |                             |                    |                  |                    |                              |
| Просмотр видео                                 | 1,471                       | 883                | 221              | 221                | 147                          |
| Лайки видео                                       | 141                         | 85                 | 21               | 21                 | 14                           |
| Лайки комментариев                         | 28                          | 17                 | 4                | 4                  | 3                            |
| Комментарии                                      | 45                          | 27                 | 7                | 7                  | 5                            |
| Подписки                                            | 389                         | 233                | 58               | 58                 | 39                           |
| Плейлисты                                          | 33                          | 20                 | 5                | 5                  | 3                            |
| Авторизация                                      | 0.8275                      | 0.5                | 0.12             | 0.12               | 0.08                         |
| Регистрация                                      | 0.386                       | 0.23               | 0.06             | 0.06               | 0.04                         |
| Загрузка видео                                 | 43                          | 26                 | 6                | 6                  | 4                            |
| История просмотров                         | 1,529                       | 917                | 229              | 229                | 153                          |
...
![ip_tunneling](img/ip_tunneling.png)
